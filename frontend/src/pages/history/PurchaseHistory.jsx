...
export default function PurchaseHistory({ account, status, setStatus }) {
  ...
  return (
    <div>
      ...
      >
        <div>
          <h1 style={{ marginBottom: "6px" }}>Purchase History</h1>
          <p style={{ margin: 0, color: "var(--text-secondary)" }}>
            Track all your completed fruit purchases.
          </p>
        </div>
      ...
      {!loading && history.length > 0 && (
        ...
        >
          ...
          <div className="fruit-card">
            ...
            <h3 style={{ margin: 0 }}>{summary.totalSpent} ETH</h3>
          </div>
        </div>
      )}
      ...
      {loading ? (
        ...
        <div className="fruit-card">
          <h3 style={{ marginTop: 0 }}>No purchases yet</h3>
            ...
            <div key={index}>
              ...
              >
                ...
                <div>
                  ...
                  <strong>{formatAddress(item.seller)}</strong>
                </div>
